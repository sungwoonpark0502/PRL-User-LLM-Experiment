...
import { BookOpen, PenLine, Code, Upload, Plus, Trash2, Save, ArrowLeft } from "lucide-react"
...
export default function ResearcherPage() {
  ...
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (files && files.length > 0) {
      ...
      setUploadedMaterials([...uploadedMaterials, ...newMaterials])
      toast({
  ...
  const handleGenerateExperiment = () => {
    // In a real app, you would generate the experiment based on the configuration
    toast({
      title: "Generated",
      description: "Your experiment has been generated and is ready for participants.",
    })
  }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button onClick={handleGenerateExperiment}>Create</Button>
          </div>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <Select value={selectedSection} onValueChange={(value) => setSelectedSection(value as Section)}>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <Select defaultValue="all-difficulties">
                        <SelectTrigger>
                        ...
                        questions.map((question) => (
                          ...
                          >
                            <div className="flex-1">
                              ...
                              <p className="text-sm dark:text-gray-300">{question.content}</p>
                            </div>
                            <Button
                              variant="ghost"
                              size="icon"
          ...
          <TabsContent value="config" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Configure the number of questions for each section.</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
          ...
          <TabsContent value="materials" className="space-y-4">
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Upload and manage materials for the experiment.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="upload-materials">Upload Files</Label>
                    <div className="border-2 border-dashed rounded-md p-4 text-center dark:border-gray-700">
                        ...
                        uploadedMaterials.map((material, index) => (
                          ...
                          >
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <p className="text-sm font-medium dark:text-gray-200">{material}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400">
